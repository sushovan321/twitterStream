$(document).ready(function () {
    ...
    var words = ["Word Cloud", "Live", "Tweets", "From", "Cities/Countries", "Streaming", "Every 5 Secs", "Word Cloud", "Live", "Tweets", "From", "Cities/Countries", "Streaming", "Every 5 Secs", "Project Author", "@sushovans"];
    ...
    try {
        ...
        words = ["Project Author", "@sushovans", "Project Author", "@sushovans", "Internet Explorer", "Does not Support EventSource", "Please use Chrome!", "Please use Chrome!", "IE Support coming up", "in WebSocket version"];
